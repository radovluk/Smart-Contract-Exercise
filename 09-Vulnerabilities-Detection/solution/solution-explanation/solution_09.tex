...
\noindent
The solved Exercise 09 - Fuzzing can be found in this \href{https://gitlab.fel.cvut.cz/radovluk/smart-contracts-exercises/-/tree/main/09-Fuzzing/solution/solution-code?ref_type=heads}{GitLab repository}.
