...
contract PiggyBankStatelessFuzzTest is Test {
    ...
    function testFuzz_MultipleDeposits(
        ...
        // ============================================================
        // EXERCISE: Implement test for multiple deposits with fuzz parameters
        //
        // 1. Bound the input parameters to reasonable ranges
        // 2. Have alice, bob, and owner each make deposits using the bounded amounts
        // 3. Calculate the total expected deposit
        // 4. Verify totalDeposits matches the sum of all deposits
        // 5. Verify contract balance matches the sum of all deposits
        // ============================================================
    ...
    function testFuzz_MultipleWithdrawals(
        ...
        // TODO: Implement this test
        // ============================================================
        // EXERCISE: Implement multiple withdrawals test with fuzz parameters
        //
        // 1. Bound the deposit amount to a reasonable range
        // 2. Make a deposit to the piggy bank
        // 3. Bound the withdrawal fractions and calculate withdrawal amounts
        // 4. Ensure total withdrawals don't exceed the deposit (use vm.assume)
        // 5. Record owner's balance before withdrawals
        // 6. Execute multiple withdrawals
        // 7. Verify totalWithdrawals, contract balance, and owner's balance
        // ============================================================
        assertTrue(false, "Test not implemented yet");
    }
    ...
    function testFuzz_CompleteWithdrawal(uint256 depositAmount) public {
        // TODO: Implement this test
        // ============================================================
        // EXERCISE: Implement complete withdrawal test with fuzz parameter
        //
        // 1. Bound the deposit amount to a reasonable range
        // 2. Make a deposit to the piggy bank
        // 3. Withdraw the entire balance
        // 4. Verify contract balance is zero after withdrawal
        // 5. Verify totalWithdrawals equals totalDeposits
        // ============================================================
        assertTrue(false, "Test not implemented yet");
    }
    ...
    function testFuzz_NonOwnerWithdrawFails(
        ...
        // TODO: Implement this test
        // ============================================================
        // EXERCISE: Implement non-owner withdrawal test with fuzz parameters
        //
        // 1. Exclude owner from test addresses using vm.assume
        // 2. Bound deposit amount to a reasonable range
        // 3. Make a deposit to the piggy bank
        // 4. Bound withdrawal amount to be within the deposit
        // 5. Ensure non-owner address is funded so it can make transactions
        // 6. Attempt withdrawal from non-owner and verify it reverts with NotOwner error
        // ============================================================
        assertTrue(false, "Test not implemented yet");
    }
