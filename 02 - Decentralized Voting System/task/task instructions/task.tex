...
% Přidání balíčku pro záhlaví a zápatí
\usepackage{fancyhdr}
\pagestyle{fancy}

% Definice záhlaví a zápatí
\fancyhf{} % Vymazání aktuálního nastavení
\fancyhead[L]{Smart Contracts Exercise 02} % Levé záhlaví
\fancyhead[R]{\thepage} % Pravé záhlaví s číslem stránky

\renewcommand{\headrulewidth}{0.4pt} % Čára pod záhlavím
% \renewcommand{\footrulewidth}{0.4pt} % Čára nad zápatím
...
In this exercise, you will implement a decentralized voting system on the blockchain. This will be a simple smart contract that allows address owners to vote for individual candidates and subsequently display the voting results. The goal of this exercise is to familiarize yourself with the basics of the Solidity language.

To get started, visit the following \href{https://gitlab.fel.cvut.cz/radovluk/smart-contracts-exercises/-/tree/main/tasks/02%20-%20Decentralized%20Voting%20System?ref_type=heads}{GitLab repository} and clone it to your local machine. This repository contains a template in which you will complete this exercise. Your implementation will be in the file \textit{contracts/Voting.sol}. To verify that you have implemented the contract correctly, you will also have access to tests.
