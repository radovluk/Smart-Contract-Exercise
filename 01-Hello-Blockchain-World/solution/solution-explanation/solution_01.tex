...
\maketitle
The implementation of the code can be found in this \href{https://gitlab.fel.cvut.cz/radovluk/smart-contracts-exercises/-/tree/main/01-%20Hello-Blockchain-World/solution/solution-code?ref_type=heads}{GitLab repository}.
