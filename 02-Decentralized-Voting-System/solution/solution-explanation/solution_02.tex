...
\title{Smart Contracts Exercise 02: \\ Decentralized Voting System -- Solution}
\author{}
\date{}
...
\noindent
The example implementation of the Voting contract can be found in this \href{https://gitlab.fel.cvut.cz/radovluk/smart-contracts-exercises/-/tree/main/02-Decentralized-Voting-System/solution/solution-code?ref_type=heads}{GitLab repository}.
