...
| 4 | Token price increases | After Bob's purchase, token price increases according to P_new = (y - Δy)/(x + Δx) where Δx is Bob's input and Δy is tokens received. |
...
See also this example where a MEV searcher purchased every single Cryptopunk at the floor price for 7 million USD: [Searcher's address](https://etherscan.io/address/0x650dCdEB6ecF05aE3CAF30A70966E2F395d5E9E5).
